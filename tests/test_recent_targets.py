...
class RecentTargetHistoryTests(unittest.TestCase):
    ...
    def test_recent_conversation_does_not_fallback_to_name_when_structural_identity_disappears(self):
        history = RecentTargetHistory()
        conversation = SimpleNamespace(
            hwnd=55,
            pid=555,
    ...
    def test_recent_conversation_rejects_runtime_match_with_changed_structure(self):
        history = RecentTargetHistory()
        conversation = SimpleNamespace(
            hwnd=55,
            pid=555,
            name="Project Chat",
            runtime_id=(1, 2, 3),
            control_identity=("ListItem", "conversation", "row", "uia"),
            container_identity=("ancestor1", "Pane", "workspace-a", "uia"),
            left=10,
            top=20,
            right=250,
        ...
        replacement = SimpleNamespace(
            ...
            name="Project Chat",
            runtime_id=(1, 2, 3),
            control_identity=("ListItem", "conversation", "changed", "uia"),
            container_identity=("ancestor1", "Pane", "workspace-b", "uia"),
            left=10,
            top=20,
            right=250,
    ...
    def test_recent_conversation_does_not_fallback_to_name_when_runtime_identity_disappears(self):
        history = RecentTargetHistory()
        conversation = SimpleNamespace(
            hwnd=55,
            pid=555,
